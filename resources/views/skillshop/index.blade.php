...
<div class="container lg mx-auto flex flex-col justify-center items-center skillshop-container">
    ...
    <div class="container lg mx-auto flex flex-col justify-center items-center skillshop-form-container">
        ...
        <form class="w-full max-w-2xl">
            ...
            <div id="price-point-container" class="flex flex-col">
                <div id="price-point-wrapper" class="container price-container flex items-center my-10">
            ...
            <div class="price-btn-container">
                <a id="price-btn" class="price-point bg-white hover:bg-gray-100 text-gray-800 font-semibold py-2 px-4 border border-gray-400 rounded shadow">
